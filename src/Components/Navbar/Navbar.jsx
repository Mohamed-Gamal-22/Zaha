    ...
    <SearchInput />
      <nav className={`bg-color p-2 text-capitalize fixed-bottom`}>
        <div className="container d-flex justify-content-around align-items-center">
          ...
          <div className="ico d-flex align-items-center justify-content-center small flex-column light-color pointer">
          ...
          <div className="ico small d-flex align-items-center justify-content-center small flex-column light-color pointer">
