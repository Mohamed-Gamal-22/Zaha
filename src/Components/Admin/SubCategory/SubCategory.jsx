...
export default function SubCategory() {
  ...
  async function getSubCategories(pageNumber = 1) {
    try {
      const { data } = await axios.get(
        `https://www.zahascarves.com/api/subcategory/all?page=${pageNumber}`,
        {
          headers: {
  ...
  async function getCategories() {
    try {
      ...
      while (pageNumber <= totalPages) {
        const { data } = await axios.get(
          `https://www.zahascarves.com/api/category/all?page=${pageNumber}`,
          {
            headers: {
              Authorization: `Bearer tmTqMwqaJf0gGEQWE5kQAkfn37ITr46RpjVCfHWha266e4cc`,
            },
  ...
  async function addSubCategory() {
    ...
    try {
      const { data } = await axios.post(
        `https://www.zahascarves.com/api/subcategory/create`,
  ...
  async function updateSubCategory() {
    ...
    try {
      await axios.post(
        `https://www.zahascarves.com/api/subcategory/update/${selectedSubcategoryId}`,
        {
  ...
  async function deleteSubCategory(id) {
    try {
      await axios.get(
        `https://www.zahascarves.com/api/subcategory/delete/${id}`,
        {
          headers: {
            Authorization: `Bearer tmTqMwqaJf0gGEQWE5kQAkfn37ITr46RpjVCfHWha266e4cc`,
          },
  ...
  for (let i = 1; i <= lastPage; i++) {
    paginationItems.push(
      <Pagination.Item
        ...
        onClick={async() => await getSubCategories(i)}
      >
        {i}
      </Pagination.Item>
    );
